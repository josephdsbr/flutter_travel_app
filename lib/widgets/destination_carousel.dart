...
import 'package:travelAppFlutter/models/destination_model.dart';
import 'package:travelAppFlutter/screens/destination_screen.dart';
          ...
          child: Row(
            ...
            children: <Widget>[
              ...
              GestureDetector(
                ...
                child: Text(
                  'See All',
                  style: TextStyle(color: Theme.of(context).primaryColor, fontSize: 16.0, fontWeight: FontWeight.w600, letterSpacing: 1.0),
                )
              )
            ],),
        ),
